...
class UserFriendsTest {
    ...
    void shouldGetUserById() throws Exception {
        ...
        int userId = Integer.parseInt(response.substring(response.indexOf("\"id\":") + 5, response.indexOf(",")));
    ...
    void shouldAddFriend() throws Exception {
        ...
        int userId1 = Integer
                .parseInt(userResponse1.substring(userResponse1.indexOf("\"id\":") + 5, userResponse1.indexOf(",")));
        ...
        int userId2 = Integer
                .parseInt(userResponse2.substring(userResponse2.indexOf("\"id\":") + 5, userResponse2.indexOf(",")));
    ...
    void shouldGetCommonFriends() throws Exception {
        ...
        int userId3 = Integer
                .parseInt(userResponse3.substring(userResponse3.indexOf("\"id\":") + 5, userResponse3.indexOf(",")));
